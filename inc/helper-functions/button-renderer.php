...
if ( ! function_exists( 'lsc_render_button' ) ) {
	function lsc_render_button( $button_link, $args = [] ) {
...
if ( ! function_exists( 'lsc_render_buttons' ) ) {
	function lsc_render_buttons( $buttons, $args = [] ) {
