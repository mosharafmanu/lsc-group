...
?>
	...
	<main id="primary" class="site-main blog-page">
		...
		<header class="blog-page-header lsc-container layout-padding">
			<div>
			...
			?>
				<span class="blog-page-count"><?php printf(
					esc_html( _n( '%s article', '%s articles', $total, 'lsc-group' ) ),
					number_format_i18n( $total )
				); ?></span>
			<?php endif; ?>
		</header>

		<div class="blog-search-bar lsc-container layout-padding pt-30 pb-30">
			<?php get_search_form(); ?>
		</div>

		<section class="blog-grid-section lsc-container layout-padding pt-20">
			<?php if ( have_posts() ) : ?>
