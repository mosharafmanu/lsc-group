...
LSC Group is a personal WordPress theme framework built for repeatable custom ACF-based projects. It is not a theme you activate and use out of the box. It is a starting point that you configure and build on top of for each client.
...
- **Project section templates** — section markup is built from the client design
...
LSC Group ships with a self-contained, removable WooCommerce module —
...
4. Update local font files and `@font-face` declarations in `style.css`
...
| Convention | Value |
|---|---|
| Function prefix | `lsc_` |
| Text domain | `lsc-group` |
| CSS token prefix | `--lsc-` |
...
| `group_site_settings.json` | Site Settings — logo, header phone/CTA, footer contact details, company registrations, copyright, website credit |
